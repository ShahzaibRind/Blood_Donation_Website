    ...
    <form action="includes/register.inc.php" method="POST">
      ...
      <br>
       <input style="
			...
			margin-bottom: 20px;
			font-size: 14px;
			color: #fff;" type="text" name="cnic" placeholder="CNIC wihtout Dashes" required>
      <br>
      ...
      <input style="
			...
			margin-bottom: 20px;
			font-size: 14px;
			color: #fff;" type="text" name="fname" placeholder="FirstName" required>
      <br>
      ...
      <input style="
			...
			margin-bottom: 20px;
			font-size: 14px;
			color: #fff;" type="text" name="lname" placeholder="LastName" required>
      <br>
      <!-- 
      Male:<input type="radio" checked="checked"name="Sex" value="male">
      Female:<input type="radio"name="Sex" value="female">
      BBA<input type="checkbox" name="BBA" value="">IT<input type="checkbox" name="IT" value="">English<input type="checkbox" name="English" value="">
       -->
       ...
       <input style="width: 100%;
			...
			margin-bottom: 20px;
			font-size: 14px;
			color: #fff;" type="text" name="group" placeholder="Blood Group" required>
       <br>
       ...
       <input style="
			...
			margin-bottom: 20px;
			font-size: 14px;
			color: #fff;" type="text" name="address" placeholder="Current Address" required>
       <br>
       <input style="
       		width: 100%;
			background: none;
			...
			margin-bottom: 20px;
			font-size: 14px;
			color: #fff;" type="text" name="contact" placeholder="Phone Number" required>
       <br>
      <input style="
      		width: 100%;
			background: none;
